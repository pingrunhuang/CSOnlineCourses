...
def forward_propagation_with_dropout(X, parameters, keep_prob = 0.5):
    ...
    Z1 = np.dot(W1, X) + b1
    A1 = relu(Z1)
    # try using randn(normal distribution aka gaussian distribution) here, some interesting stuff will happend
    # here is using uniform distribution where the value is in between 0 - 1
